...
\subsection{Introducing Schemas to Reactive \acrlongpl{is}}
...
\cite{kreps}\todo{add other potential citations} address it by introducing a dedicated software component to their system that stores schemas and makes them available.
